...
This repository is published for personal use only. It is provided as-is, with no warranty, support commitment, or responsibility assumed by the maintainer for any usage, deployment, account, billing, data, compliance, or service-availability consequences.
